...
func (c *GorseClient) DeleteFeedback(ctx context.Context, feedbackType, userId, itemId string) (RowAffected, error) {
	return request[RowAffected, any](ctx, c, "DELETE", c.entryPoint+fmt.Sprintf("/api/feedback/%s/%s/%s", feedbackType, userId, itemId), nil)
}

func (c *GorseClient) DeleteFeedbacks(ctx context.Context, userId, itemId string) (RowAffected, error) {
